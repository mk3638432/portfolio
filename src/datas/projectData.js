export const projectsList = [
...

  {
    ...
    title: "Evently",
    description:
      "Developed and launched Evently, an innovative event creation and management platform that empowers users to seamlessly create, publish, and manage their events on the evently website.",
  },
];
